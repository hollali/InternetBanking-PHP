    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <p class="mb-1">
            <a href="../staff/pages_staff_index.php"> <div class="col-8">
                <button type="submit" name="login" class="btn btn-danger btn-block">STAFF PANEL</button>
              </div></a>
          </p>
          <p class="mb-1">
            <a href="../client/pages_client_index.php"> <div class="col-8">
                <button type="submit" name="login" class="btn btn-danger btn-block">CLIENT PANEL</button>
              </div></a>
          </p>
