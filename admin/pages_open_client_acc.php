...
if (isset($_POST['open_account'])) {
    ...
    if ($stmt) {
        $success = "PK TRUSTLINE Account Opened";
    } else {
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Open <?php echo $row->name; ?> PK TRUSTLINE Account</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="pages_open_acc.php">PK TRUSTLINE Accounts</a></li>
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="open_account" class="btn btn-success">Open PK TRUSTLINE Account</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
