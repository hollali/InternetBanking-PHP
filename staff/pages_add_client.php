                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="pages_add_client.php">PK TRUSTLINE Clients</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class=" col-md-6 form-group">
                                                ...
                                                ?>
                                                <input type="text" readonly name="client_number" value="PKTMC-CLIENT-<?php echo $_Number; ?>" class="form-control" id="exampleInputPassword1">
                                            </div>
                                        </div>
