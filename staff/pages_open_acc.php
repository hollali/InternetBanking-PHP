    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Open a PK TRUSTLINE Account</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="">PK TRUSTLINE Accounts</a></li>
                <li class="breadcrumb-item active">Open PK TRUSTLINE Account</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
