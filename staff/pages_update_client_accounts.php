            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update <?php echo $row->client_name; ?> PK TRUSTLINE Account</h1>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="update_account" class="btn btn-success">Update PK TRUSTLINE Account</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
